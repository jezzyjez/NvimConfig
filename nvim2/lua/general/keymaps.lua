...
keymap("n", "<leader>c", "<cmd>CodeCompanionChat Toggle<cr>", opts)
...
-- Grug
keymap("n", "sr", ":lua require('grug-far').open()<CR>", opts)
keymap("v", "sr", ":lua require('grug-far').open({ prefills = { search = vim.fn.expand('<cword>') } })<CR>", opts)
